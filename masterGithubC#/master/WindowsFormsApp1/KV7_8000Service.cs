...
namespace KeyenceComunicationTest
{
    class KV7_8000Service
    {
        ...
        public bool ReConnext()
        {
            ...
            {
                throw new Exception("没有IP和端口请调用Connect函数连接"); //return false;这条代码不会执行，my
            }
        ...
        /// <returns></returns>
        public string ClearCPUError()
        {
            string str = Command2+ CR;
            return SendRecive(str);
        }
        /// <summary>
        /// 获取错误编号，my
        ...
        /// <param name="run"></param>
        /// <returns></returns>
        public string GetCPUErrorSerialNumber(bool run = true)
        {
            string str = Command3 + CR;
            return SendRecive(str);
        }
        /// <summary>
        /// 查看PLC运行状态
